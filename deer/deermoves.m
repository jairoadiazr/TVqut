        ...
        for OV = OVs
            ...
            for year1 = year1s
                ...
                for ehdv = ehdvs
                    ...
                    filename = strcat('deer_EHDV-',num2str(ehdv),'_weight_',num2str(weight),'_year_',num2str(year), '_interpolation_',num2str(interpolation), '_', ov,'.mat')
                    ...
                    [X, y] = bootstrap_moves(X, y, 20, 2000,0);
                    ...
                    subplot(131)
                    %naive estimator
                    prop_vect_naive = sum(X(y==0,:));
                    prop_naive = NaN(max(points));
                    for i = 1:length(prop_vect_naive)
                    ...
                    filename = strcat('deer_EHDV-',num2str(ehdv),'_weight_',num2str(weight),'_year_',num2str(year), '_interpolation_',num2str(interpolation), '_', ov,'.mat')
                    save(filename,'y','prop_vect_naive','prop_vect_glm','prop_vect_hat','prophat','prop_hat','propnaive','prop_naive','propglm','prop_glm','Lambdas','lambda_max','lambda_qut','X','D_TV','-v7.3')
